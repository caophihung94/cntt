...
<div class="content-box">
    <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
            ...
            <li><a href="#" class="default-tab current"><i class="fa fa-user-plus"></i> Chỉnh sửa thành viên</a></li>
        </ul>
        <div class="clear"></div>
            ...
            <form action="" method="post">
                <fieldset>
                    ...
                    <p>
                        ...
                        <?php echo form_dropdown('group', $group, $user['group_id'], 'class="medium-input"'); ?>
                        <?php echo form_error('group', '<span class="input-notification error png_bg">', '</span>'); ?>
                    </p>

                    <p>
                        <label>Trạng thái</label>
                        <?php echo form_dropdown('status', ['0' => 'Bị cấm', '1' => 'Hoạt động'], $user['status'], 'class="medium-input"'); ?>
